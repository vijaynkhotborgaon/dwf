...
<tbody>
<tr>
<td colspan="7"><h4 style="float:left;"><strong>New Company Registration List</strong></h4></td>
</tr>
...
<?php
$result = mysql_query("SELECT * FROM company_lead WHERE ts_id=$sesstsid AND status=0");
$i=1;
...
<td><a href="leadcompany-detail.php?cid=<?php echo $row['lead_id']; ?>"><img src="../images/View-detail.png" alt="View Details" /></a></td>
</tr>
<?php   $i++; } ?>
</tbody>
</table>
