...
if(isset($_SESSION['SESS_CAM_ID']) || (trim($_SESSION['SESS_CAM_ID']) != '') || (trim($_SESSION['SESS_CAM_PRIORITY']) == '2')) {
...
<br>
<button type="submit">Log in</button><a href="<?php echo $mainurl; ?>"><button class="cancel" type="button">Cancel</button></a>
</div>
</div>
</form>
