...
<textarea name="mailspoc" class="jqte-test"><p><b>Hi <?php echo $row['cperson']; ?></b>,</p><p>Your Company Contract with <b>Disclose Without Fear!</b> is expiring on <?php echo $row1['tilldate']; ?>, please contact us to extend your contract period</p>
...
<textarea name="mailcam" class="jqte-test"><p><b>Hi <?php echo $row2['name']; ?></b>,</p><p>The Company that assigned to you, <strong><?php echo $row['cname']; ?></strong>, Contract is expiring on <?php echo $row1['tilldate']; ?>, please contact the company spoc to extend the company contract period</p><p><b>Contract Period:</b></p><p><b>Active From:</b> <?php echo $row1['fromdate']; ?><br><b>Till From:</b> <?php echo $row1['tilldate']; ?></p></textarea>
