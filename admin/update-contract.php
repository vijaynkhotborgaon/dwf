...
$result4 = mysql_query("SELECT * FROM camdetails where cam_id=".$row2['cam_id']);
$row4 = mysql_fetch_assoc($result4);
	
	

echo $mailspoc= "<p><b>Hi ". $row2['cperson']."</b>,</p><p>Your Company Contract has been renewed till ".$Active_Till."</p><p><b>Contract Period:</b></p><p><b>Active From:</b>".$row3['fromdate']."<br><b>Till From:</b> ".$Active_Till."</p>";
...
echo $mailcam= "<p><b>Hi ". $row4['name']."</b>,</p><p>The Company that assigned to you, ". $row2['cname'].", Contract has been renewed till ".$Active_Till."</p><p><b>Contract Period:</b></p><p><b>Active From:</b>".$row3['fromdate']."<br><b>Till From:</b> ".$Active_Till."</p>";
