...
<p style="text-align:center; width:110px; margin:8px; float:left; height:120px;"><a href="view-full-details.php?companyid=<?php echo $row['company_id']; ?>"><img class="clogo" src="../<?php echo $row['clogo']; ?>" alt="<?php echo $row['clogo']; ?>" /></a>
