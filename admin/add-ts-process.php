...
$camid = clean($_POST['camid']);
	...
	$qry = "INSERT INTO ts(ts_name, ts_pword, ts_published, modified_on, created_on) VALUES('$uname','".md5($pword)."','1',NOW(),NOW())";

	$result = @mysql_query($qry);
	
	$qry2 = "INSERT INTO tsdetails(name, email, tel_no, alternate_no) VALUES('$name','$email','$telephone','$phone')";
