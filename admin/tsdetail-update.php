...
<html lang="en-gb" dir="ltr" class="com_content view-article itemid-723 j33 no-touch"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <title>Update Technical Support Details</title>
...
$result = mysql_query("SELECT * FROM tsdetails WHERE ts_id=".$tsid);
...
$result2 = mysql_query("SELECT * FROM ts WHERE ts_id=".$tsid);
...
?>
    ...
    <input name="tsid" type="hidden" value="<?php echo $tsid; ?>">
...
<td colspan="2"><h4><strong>Update Technical Support Details</strong></h4></td>
...
<td colspan="2"><h4><strong>Change Technical Support Password</strong></h4></td>
