...
$html ='<html style="background-color:#F3E2A9;"><body> <div><div>';   
...
$html.='<div id="formWrapper" ><table border="0" width="100%"><tbody><tr><td width="20%"><h2>'.$row1["cname"].'</h2></td><td width="60%">&nbsp;</td><td width="20%"><img src="../'.$row["clogo"].'" alt="'.$row1["cname"].'" /></td></tr></tbody></table><table border="1" width="100%"><tbody><tr style="background-color:#F5DA81;"><td colspan="6"><h4><strong>Complaint List</strong></h4></td></tr><tr style="text-align: center; background-color:#E0F8F7;"><td style="text-align: center;"><strong>Complaint ID</strong></td><td><strong>Complaint Category</strong></td><td><strong>Complaint Department</strong></td><td><strong>Status</strong></td><td><strong>Created Date</strong></td></tr>';
...
$html.='<tr style="text-align: center;background-color:#A9BCF5;"><td>'.$row["ticket"].'</td>';
...
$html.='<td>'.$status.'</td><td>'.$row["created_on"].'</td></tr>';
 ...
 $filename=$row1["cname"]."_Report_".date('d')."_".date('m')."_".date('y').".pdf";
