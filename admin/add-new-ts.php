...
<html lang="en-gb" dir="ltr" class="com_content view-article itemid-723 j33 no-touch"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <title>Add New Techinal Support</title>
...
<?php
	...
	if(isset($_SESSION['TSREGMESG']) && $_SESSION['TSREGMESG']==1 ) {
...
<p>New Techinal Support added successfully</p>
...
?>
    ...
    <form action="add-ts-process.php" method="post">
...
<td colspan="2"><h4><strong>Add New Techinal Support</strong></h4></td>
